                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <form @submit.prevent="submit" class="p-6">
                            ...
                            <div v-for="(item, index) in form.items" :key="index" class="mb-6 p-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-900">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="md:col-span-2">
                                        ...
                                        />
                                        <div v-if="form.errors[`items.${index}.medication_name`]" class="text-sm text-red-600 mt-1">
                                            {{ form.errors[`items.${index}.medication_name`] }}
                                        </div>
                                    </div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            >
                                {{ form.processing ? 'Đang Lưu...' : 'Lưu Tơ Thuốc' }}
                            </button>
                        </div>
                    </form>
                </div>
