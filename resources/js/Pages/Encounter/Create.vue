                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <form @submit.prevent="submit" class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    ></textarea>
                                    <div v-if="form.errors.chief_complaint" class="text-sm text-red-600 mt-1">{{ form.errors.chief_complaint }}</div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                    ></textarea>
                                    <div v-if="form.errors.present_illness" class="text-sm text-red-600 mt-1">{{ form.errors.present_illness }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            >
                                {{ form.processing ? 'Đang Lưu...' : 'Lưu Cuộc Khám' }}
                            </button>
                        </div>
                    </form>
                </div>
